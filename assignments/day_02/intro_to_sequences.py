...
'''
foods = ["beef noodles","peanut noodles","protien shakes"]
...
# the program is trying to find a value that doesn't exist 
...
#the element is undefined because you are requesting data that doesn't exist
...
#Yes, you are still trying to remove a value that does not exist
